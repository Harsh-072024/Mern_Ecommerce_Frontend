            ...
            <section aria-labelledby="products-heading" className="pt-6 pb-24">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                <Link
                  ...
                  className="rounded-md mx-10 bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600"
                >
                  Add New Product
                </Link>
              </div>
                  <ProductGrids products={products}></ProductGrids>
                </div>
              </div>
            </section>
                    ...
                    <div className="flex h-5 shrink-0 items-center">
                      <div className="group grid size-4 grid-cols-1">
                        <input
                          ...
                          type="checkbox"
                          onChange={(e) => handleFilter(e, section, option)}
                          className="h-4 w-4 rounded border-gray-300 text-white accent-indigo-600 focus:ring-indigo-500"
                        />
                        <svg
                          fill="none"
                          viewBox="0 0 14 14"
                  ...
                  <div className="group relative border-solid border-2 border-gray-200 p-2">
                    ...
                    <div className="mt-4 flex justify-between">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-gray-400 line-through block">
                          ${product.price}
                        </p>
                      </div>
                    </div>
